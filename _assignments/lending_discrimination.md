...
financial institutions across the US that have been made publicly available under the Home Mortgage Disclosure Act (HMDA) (*Download HMDA Data*). The records gathered reflect individual applications wherein one of the following eight potential actions were taken (*A Guide To HMDA Reporting: Getting It Right!*).
