---
title: |
  <center> \Large Realizing Fairness in an Unfair World: </center>
  <center> \Large A Causal Approach to Fair Predictive Modeling via </center>
  <center> \vspace{-0.1cm} \Large Penalized Maximum Likelihood Estimation </center>
subtitle: |
  <center> \vspace{0.25cm} Biostatistics Master's Project <center>
author: 
  - Antonella Basso
  - \text{ }
...
#date: "May 1, 2023"
# date: |
#   \large Brown University School of Public Health, 2023
...
#write.csv(lambda_results_5, "C:\\Users\\antonellabasso\\Desktop\\new_lambda_results.csv")
lambda_results_5 <- read.csv("/Users/antonellabasso/Desktop/Master's Thesis/new_lambda_results.csv") %>%
...
colnames(beta_df) <- c("$\\beta_{a,0}$", "$\\beta_{a,x}$", 
                       "$\\beta_{m,0}$", "$\\beta_{m,x}$", 
                       "$\\beta_{m,a}$", "$\\beta_{y,0}$", 
                       "$\\beta_{y,x}$", "$\\beta_{y,a}$", 
                       "$\\beta_{y,m}$")
...
knitr::kable(beta_df,
             caption="Initial Parameter Values for Unfair Data",
             booktabs=TRUE, linesep="", escape=FALSE, align="c") %>% 
  kable_styling(latex_options="hold_position") 
```

```{r, echo=FALSE, fig.show='asis', fig.align='center', out.width="60%", fig.cap="Unfair World Outcome Distributions by Group"}
data_5_dist
```
...
beta_opt_df <- format(round(data.frame(a_0=beta_opt_5[1], a_x=beta_opt_5[2], 
  ...
  mutate(y_a=cell_spec(y_a, color="red"))
colnames(beta_opt_df) <- c("$\\beta_{a,0}$", "$\\beta_{a,x}$", 
                           "$\\beta_{m,0}$", "$\\beta_{m,x}$", 
                           "$\\beta_{m,a}$", "$\\beta_{y,0}$", 
                           "$\\beta_{y,x}$", "$\\beta_{y,a}$", 
                           "$\\beta_{y,m}$")
...
knitr::kable(beta_opt_df,
             caption="Optimal Parameter Values for Fair Data",
             booktabs=TRUE, linesep="", escape=FALSE, align="c") %>% 
  kable_styling(latex_options="hold_position") 
```
...
```{r echo=FALSE, fig.show='asis', fig.align='center', warning=FALSE, out.width="70%"}
results_5_plot1 
```

&nbsp;

```{r, warning=FALSE, echo=FALSE, fig.show='asis', fig.align='center', out.width="70%", fig.cap="Negative Log-Likelihood \\& Mean Squared Error vs. Natural Direct Effect"}
results_5_plot2
```

\newpage

```{r echo=FALSE, fig.align='center', fig.show='asis', warning=FALSE, out.width="64%"}
results_5_plot3
results_5_plot4
```

```{r, warning=FALSE, echo=FALSE, fig.show='asis', fig.align='center', out.width="64%", fig.cap="Negative Log-Likelihood, Mean Squared Error, \\& Natural Direct Effect for Varying Lambda"}
results_5_plot5
```
...
> > > > &mdash; *Judea Pearl, "The Book of Why"*
...
<!-- [1] Altman, Micah, Alexandra Wood, and Effy Vayena. “A Harm-Reduction Framework for Algorithmic Fairness.” IEEE Security & Privacy 16, no. 3 (May 2018): 34–45. https://doi.org/10.1109/MSP.2018.2701149. -->

<!-- [2] Barocas, Solon, Moritz Hardt, and Arvind Narayanan. “Fairness and Machine Learning Limitations and Opportunities,” 2018. https://www.semanticscholar.org/paper/Fairness-and-Machine-Learning-Limitations-and-Barocas-Hardt/bae7f0b3448a3eac77886f2a683c0cf9256bb8bf. -->

<!-- [3] Bonchi, Francesco, Sara Hajian, Bud Mishra, and Daniele Ramazzotti. “Exposing the Probabilistic Causal Structure of Discrimination.” International Journal of Data Science and Analytics 3 (February 1, 2017). https://doi.org/10.1007/s41060-016-0040-z. -->

<!-- [4] Calders, Toon, Asim Karim, Faisal Kamiran, Wasif Ali, and Xiangliang Zhang. “Controlling Attribute Effect in Linear Regression.” In 2013 IEEE 13th International Conference on Data Mining, 71–80, 2013. https://doi.org/10.1109/ICDM.2013.114. -->

<!-- [5] Helwegen, Rik, Christos Louizos, and Patrick Forré. “Improving Fair Predictions Using Variational Inference In Causal Models.” arXiv, August 25, 2020. https://doi.org/10.48550/arXiv.2008.10880. -->

<!-- [6] Hernán, Miguel A, and James M Robins. Causal Inference: What If. Boca Raton: Chapman & Hall/CRC., 2020. -->

<!-- [7] Howe, Chanelle J, Zinzi D Bailey, Julia R Raifman, and John W Jackson. “Recommendations for Using Causal Diagrams to Study Racial Health Disparities.” American Journal of Epidemiology 191, no. 12 (November 19, 2022): 1981–89. https://doi.org/10.1093/aje/kwac140. -->

<!-- [8] Issa Kohler-Hausmann. “Eddie Murphy and the Dangers of Counterfactual Causal Thinking About Detecting Racial Discrimination.” Northwestern University Law Review 113, no. 5 (March 1, 2019): 1163–1228. -->

<!-- [9] Kamiran, Faisal, and Toon Calders. “Data Preprocessing Techniques for Classification without Discrimination.” Knowledge and Information Systems 33, no. 1 (October 1, 2012): 1–33. https://doi.org/10.1007/s10115-011-0463-8. -->

<!-- [10] Kamishima, Toshihiro, Shotaro Akaho, Hideki Asoh, and Jun Sakuma. “Fairness-Aware Classifier with Prejudice Remover Regularizer.” In Machine Learning and Knowledge Discovery in Databases, edited by Peter A. Flach, Tijl De Bie, and Nello Cristianini, 35–50. Lecture Notes in Computer Science. Berlin, Heidelberg: Springer, 2012. https://doi.org/10.1007/978-3-642-33486-3_3. -->

<!-- [11] Kilbertus, Niki, Philip J. Ball, Matt J. Kusner, Adrian Weller, and Ricardo Silva. “The Sensitivity of Counterfactual Fairness to Unmeasured Confounding.” arXiv, July 1, 2019. https://doi.org/10.48550/arXiv.1907.01040. -->

<!-- [12] Lange, Theis, Mette Rasmussen, and Lau Caspar Thygesen. “Assessing Natural Direct and Indirect Effects Through Multiple Pathways.” American Journal of Epidemiology 179, no. 4 (February 15, 2014): 513–18. https://doi.org/10.1093/aje/kwt270. -->

<!-- [13] Loftus, Joshua R., Matt J. Kusner, Chris Russell, and Ricardo Silva. “Counterfactual Fairness.” arXiv, March 8, 2018. https://doi.org/10.48550/arXiv.1703.06856. -->

<!-- [14] Loftus, Joshua R., Matt J. Kusner, Chris Russell, and Ricardo Silva. “Causal Reasoning for Algorithmic Fairness.” arXiv, May 15, 2018. https://doi.org/10.48550/arXiv.1805.05859. -->

<!-- [15] Mancuhan, Koray, and Chris Clifton. “Combating Discrimination Using Bayesian Networks.” Artificial Intelligence and Law 22, no. 2 (June 1, 2014): 211–38. https://doi.org/10.1007/s10506-014-9156-4. -->

<!-- [16] Mehrabi, Ninareh, Umang Gupta, Fred Morstatter, Greg Ver Steeg, and Aram Galstyan. “Attributing Fair Decisions with Attention Interventions.” arXiv, September 8, 2021. https://doi.org/10.48550/arXiv.2109.03952. -->

<!-- [17] Mehrabi, Ninareh, Fred Morstatter, Nripsuta Saxena, Kristina Lerman, and Aram Galstyan. “A Survey on Bias and Fairness in Machine Learning.” arXiv, January 25, 2022. https://doi.org/10.48550/arXiv.1908.09635. -->

<!-- [18] Nabi, Razieh, and Ilya Shpitser. “Fair Inference on Outcomes.” Proceedings of the AAAI Conference on Artificial Intelligence 32, no. 1 (April 25, 2018). https://doi.org/10.1609/aaai.v32i1.11553. -->

<!-- [19] Nabi, Razieh, Daniel Malinsky, and Ilya Shpitser. “Optimal Training of Fair Predictive Models.” In Proceedings of the First Conference on Causal Learning and Reasoning, 594–617. PMLR, 2022. https://proceedings.mlr.press/v177/nabi22a.html. -->

<!-- [20] Pearl, Judea. “Causal Inference in Statistics: An Overview.” Statistics Surveys 3, no. none (January 1, 2009). https://doi.org/10.1214/09-SS057. -->

<!-- [21] Pearl, Judea. “Interpretable Conditions for Identifying Direct and Indirect Effects:” Fort Belvoir, VA: Defense Technical Information Center, June 7, 2012. https://doi.org/10.21236/ADA564093. -->

<!-- [22] Pearl, Judea. “The Causal Mediation Formula&mdash;A Guide to the Assessment of Pathways and Mechanisms.” Prevention Science 13, no. 4 (August 1, 2012): 426–36. https://doi.org/10.1007/s11121-011-0270-1. -->

<!-- [23] Qureshi, Bilal, Faisal Kamiran, Asim Karim, Salvatore Ruggieri, and Dino Pedreschi. “Causal Inference for Social Discrimination Reasoning.” arXiv, November 4, 2019. https://doi.org/10.48550/arXiv.1608.03735. -->

<!-- [24] Zhang, Brian Hu, Blake Lemoine, and Margaret Mitchell. “Mitigating Unwanted Biases with Adversarial Learning.” arXiv, January 22, 2018. https://doi.org/10.48550/arXiv.1801.07593. -->

<!-- [25] Zhang, Lu, Yongkai Wu, and Xintao Wu. “Causal Modeling-Based Discrimination Discovery and Removal: Criteria, Bounds, and Algorithms.” IEEE Transactions on Knowledge and Data Engineering 31, no. 11 (November 2019): 2035–50. https://doi.org/10.1109/TKDE.2018.2872988. -->
